      ...
      <div class="col-xs-12 col-md-6">
        <div class="card-box">
          ...
          <div class="inbox-widget nicescroll" style="height: 330px;">
            ...
            <a href="#">
              <div class="inbox-item">
                <div class="inbox-item-img"><img src="{{ asset('images/users/avatar-8.jpg') }}" class="rounded-circle" alt=""></div>
            ...
            <a href="#">
              <div class="inbox-item">
                <div class="inbox-item-img"><img src="{{ asset('images/users/avatar-9.jpg') }}" class="rounded-circle" alt=""></div>
...
@endsection
@push('plugins')
<script src="{{ asset('js/pluginsHome.js') }}"></script>
@endpush
@push('scripts')
<script src="{{ asset('js/jsPageHome.js') }}"></script>
@endpush